...
pub mod constants {
    ...
    pub const MAX_CHUNK_COUNT: usize = 16; // Increased for issues where responses cannot be returned from OPCUA Server due to the actual response size is greater than the client max_message_size.
